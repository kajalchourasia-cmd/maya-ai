...
def make_evidence(agent: AgentName, modifier: str = "base") -> WorkerEvidence:
    refs: dict[AgentName, list[EvidenceReference]] = {
        ...
        AgentName.NUTRITION: [
            ref("food-safe", EvidenceLane.STRUCTURED_CATALOGUE, label="Peanut-free vegetarian meal framework", tags=["vegetarian", "peanut-free"], duration=30, cadence=3, alternatives=["Use another verified allergen-free component"]),
            ref("food-peanut", EvidenceLane.STRUCTURED_CATALOGUE, label="Peanut snack", tags=["peanut", "vegetarian"], duration=10, cadence=3),
        ],
