...
class JourneyResolutionError(ValueError):
    """Input cannot be represented safely inside Maya AI's journey scope."""
        ...
        *,
        ...
        if isinstance(timing, PossiblePregnancyTiming):
            ...
            return JourneyResolution(
                ...
                limitations=[
                    "Maya AI does not infer pregnancy or assign a week from this input."
                ],
            )
    ...
    def resolve_approximate_month_range(
        ...
        *,
        ...
        return JourneyResolution(
            ...
            limitations=[
                "A pregnancy month is approximate, so Maya AI will not select one exact weekly profile until timing is confirmed."
            ],
        )
