...
def reciprocal_rank_score(ranks) -> float:
    """Shared ranking primitive; permission checks remain lane-specific."""
...
class RetrievalGateway:
    ...
    def _rank(self, components, limit):
        ...
        for candidate_id, candidate in candidates.items():
            rrf = reciprocal_rank_score(ranks[candidate_id].values())
