...
Think of Supabase as Maya AI's apartment building.
...
When a confirmed fact changes, Maya AI now follows all the strings tied to that
...
> “Stage 2 is Maya AI's locked data building. Every user owns one private care
