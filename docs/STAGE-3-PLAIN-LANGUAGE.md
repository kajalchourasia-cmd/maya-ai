...
Stage 3 is the front door of Maya AI. It now works.

Imagine Maya AI is a careful notebook. Before it can show the right pregnancy or
...
only knows a month, Maya AI keeps a range such as approximately weeks 18–22. It
does not pretend to know one exact week.

## What happens when two dates disagree

Maya AI shows both answers. It says there is a difference and asks the person to
...
one pregnancy-through-postpartum episode. Maya AI now blocks that backward move
...
does not understand the symptom, Maya AI asks for clarification; it does not call
