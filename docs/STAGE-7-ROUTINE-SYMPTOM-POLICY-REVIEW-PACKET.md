...
This packet prepares the product, clinical-safety and India-localisation decisions needed before routine symptom guidance can be enabled. It is not a clinical policy, an approval, or evidence that a clinician reviewed Maya AI. The deterministic Stage 6 urgent gate remains first and cannot be downgraded. Unknown, ambiguous, new or worsening symptom language continues to clarify or stop conservatively.
