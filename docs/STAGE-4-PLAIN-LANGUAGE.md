...
Think of Maya AI as having a locked envelope, a careful reader and a form that
...
2. Maya AI verifies the exact file hash, type and size, checks that it opens,
   and proves that it is bound to the expected fictional person.
3. Maya AI stores the original inside her private workspace.
...
7. Only after the whole review is complete does one protected database action save
   the approved facts.
8. If two documents disagree, Maya AI keeps both. It asks a clarification question
...
Medication wording gets extra care. Maya AI may record what a fictional document
