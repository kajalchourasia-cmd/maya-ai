...
| Earlier fixed copy used the retired assistant name “Compass” | Public-facing documentation now uses “Ask Maya”; fixed safety copy still requires product/content review before publication |
