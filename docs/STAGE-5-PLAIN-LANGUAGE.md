...
Think of Maya AI as a careful librarian. When someone asks a question, Stage 5 gathers only the allowed and relevant material:
...
## How Maya AI decides what is enough
...
Maya AI maps normal singular/plural category wording to allergies, restrictions, medications, conditions, appointments and journey timing. Users do not need to know an unresolved value or special system terminology.
