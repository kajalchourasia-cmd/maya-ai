...
# Maya AI: what happened, what failed, and how we recovered
...
current-object revocation and scoped future defaults to Maya AI's migration owner.
...
CR/LF-only serialization of nine Maya AI functions; application-role drift and
Maya AI-function semantic mismatches are both zero. The secret-free evidence is
