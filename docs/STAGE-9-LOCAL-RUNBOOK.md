...
- **A Ask Maya response is blocked:** read the clarification, abstention, or safety route. The UI does not reveal an unvalidated partial draft.
- **A citation cannot open:** return to Ask Maya, submit a supported fictional task, and choose **Open supporting evidence**. Private fixture citations are bound to the active fictional workspace.
